...
class FirstAid : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dropdownButton = findViewById<Button>(R.id.dropdown7)
        ...
        popupMenu.setOnMenuItemClickListener { item ->
            ...
            when (selectedOption) {
                ...
                "Home" -> {
                    val intent = Intent(this@FirstAid,MainActivity::class.java)
                    startActivity(intent)
                }

                "6WeekCourses" -> {
                    val intent = Intent(this@FirstAid,Week::class.java)
                    startActivity(intent)
                }

                "6MonthCourses" -> {
                    val intent = Intent(this@FirstAid,Month::class.java)
                    startActivity(intent)
                }

                "ContactUs" -> {
                    val intent = Intent(this@FirstAid,Contact::class.java)
                    startActivity(intent)
                }
